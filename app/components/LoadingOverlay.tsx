...
export default function LoadingOverlay({ isOpen, mode }: LoadingOverlayProps) {
  const messages = mode === "topics" ? topicsMessages : articlesMessages;
  const [currentMessageIndex, setCurrentMessageIndex] = useState(0);
  const [elapsedSeconds, setElapsedSeconds] = useState(0);
  const title = mode === "topics" ? "Researching outreach ideas…" : "Writing your outreach articles…";
