...
function job(id: string): AutomationJob {
  return {
    id, status: "queued",
    request: { topic: null, niche: "Music industry", category: "Spotify", anchor: "", anchorUrl: "", brand: "", brief: "", mode: "human", billing: "auto", language: "English", image: false, imageStyle: "", excludeImageStyles: [], imageQuality: "", coverFormat: "webp", imageRatio: "16:9", minWords: 1200, maxWords: 1800, seoTitleMaxChars: 65 },
