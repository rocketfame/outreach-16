...
function job(id: string): AutomationJob {
  return {
    id, status: "queued",
    request: { topic: null, niche: "Music industry", category: "Spotify", anchor: "", anchorUrl: "", brand: "", brief: "", mode: "human", language: "English", image: false, imageStyle: "", excludeImageStyles: [], imageRatio: "16:9", minWords: 1200, maxWords: 1800 },
